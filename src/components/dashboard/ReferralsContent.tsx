  ...
  return (
    <div className="max-w-5xl mx-auto space-y-12">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          <h1 className="text-4xl font-serif font-bold text-[#122c1f]">{dict.dashboard.referrals.title}</h1>
          <p className="text-[#77574d] mt-1 font-medium">
            {dict.dashboard.referrals.subtitle}
          </p>
        </div>
      ...
      <section className="space-y-6">
        ...
        <div className="bg-white rounded-[40px] border border-black/5 overflow-hidden shadow-sm">
          {loading ? (
            <div className="p-10 text-center text-[#77574d]">{dict.dashboard.referrals.loading}</div>
          ) : referrals.length === 0 ? (
            <div className="p-10 text-center">
              <Users className="w-10 h-10 text-[#122c1f]/20 mx-auto mb-3" />
              <p className="text-[#77574d] text-sm">{dict.dashboard.referrals.none}</p>
            </div>
          ) : (
