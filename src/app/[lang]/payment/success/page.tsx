  ...
  return (
    <main className="flex-1 pt-40 pb-20 px-6">
      <div className="max-w-xl mx-auto text-center">
        ...
        <h1 className="text-4xl font-serif font-bold text-[#122c1f] mb-4">Payment Successful!</h1>
        <p className="text-[#77574d] text-lg mb-10">
          Thank you for your payment. Your order has been placed successfully and is being processed.
        </p>

        <div className="bg-white rounded-[32px] border border-black/5 p-8 mb-10 text-left space-y-4 shadow-sm">
          <div className="flex justify-between text-sm">
            <span className="text-[#77574d]">Order ID</span>
            <span className="font-bold text-[#122c1f] font-mono">{orderId}</span>
          </div>
          <div className="flex justify-between text-sm border-t border-black/5 pt-4">
            <span className="text-[#77574d]">Payment ID</span>
            <span className="font-bold text-[#122c1f] font-mono">{paymentId}</span>
          </div>
          <div className="flex justify-between text-sm border-t border-black/5 pt-4">
