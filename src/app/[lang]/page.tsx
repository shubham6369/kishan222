...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* NEW: Boutique Marketplace Preview */}
      <section className="section-padding bg-[#f0f4f2] relative overflow-hidden">
        <div className="max-w-7xl mx-auto space-y-16 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end gap-8">
            ...
            >
              <h2 className="text-4xl md:text-6xl text-primary">The Boutique <br /><span className="text-accent underline decoration-accent/20 underline-offset-4">Marketplace</span></h2>
              <p className="text-primary/60 font-body text-xl">
                Rare, artisanal, and verified organic. Every product supports a single-farm lineage and direct-to-producer prosperity.
              </p>
            </motion.div>
            <motion.div {...fadeInUp}>
              <Link href={`/${lang}/marketplace`} className="inline-flex items-center gap-3 font-bold text-primary hover:text-accent-dark transition-all text-lg mb-4">
                View Collection (420+) <ArrowRight className="w-5 h-5" />
              </Link>
            </motion.div>
          </div>
          ...
          >
            {[
              ...
              >
                <div className="relative aspect-4/5 rounded-[32px] overflow-hidden bg-white mb-6 shadow-sm group-hover:shadow-xl transition-all duration-500">
                  <Image 
                    src={product.image}
                    alt={product.name}
                    fill
                  ...
                  />
                  <div className="absolute top-4 right-4 glass-panel px-3 py-1 rounded-full text-white text-xs font-bold flex items-center gap-1">
                    <Star className="w-3 h-3 fill-accent text-accent" /> {product.rating}
                  </div>
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4">
                    <button className="w-12 h-12 rounded-full bg-accent text-primary flex items-center justify-center hover:scale-110 transition-transform">
                      <ShoppingBag className="w-5 h-5" />
                    </button>
                  </div>
                  <div className="absolute bottom-4 left-4 right-4 glass-panel p-3 rounded-2xl md:translate-y-4 md:opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                ...
                <div className="flex justify-between items-center px-2">
                  ...
                  <button className="text-accent underline font-bold text-sm tracking-wide">Pre-order</button>
                </div>
              </motion.div>
            ))}
          </motion.div>
